...
import { Toggle, DashboardIcon, AccountIcon, GoalsIcon, Clipboard } from './core/Icons';
...
const Sidebar: Component<ToggleType> = (props) => {
    ...
    return (
        <aside className='w-64 min-h-full  absolute top-o left-0 bg-green-50 text-green-700 sidebar'
